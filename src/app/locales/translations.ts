export const translations = {
  'zh-CN': {
    ...
    profile: {
      ...
      goToLogin: '去登录',
      confirmDelete: '确认删除',
      deleteWallpaperConfirm: '确定要删除这个壁纸吗？此操作不可恢复。',
    ...
    settings: {
      ...
      aboutApp: '关于 MarkWallpapers',
      aboutAppDesc: '了解更多平台信息',
      dangerZone: '危险操作',
      privacyPolicy: '隐私政策',
      logOut: '退出登录',
      copyright: '© 2026 MarkWallpapers. 保留所有权利。',
      appVersion: 'MarkWallpapers v1.0.0',
      themeDarkEnabled: '已开启深色テーマ',
      themeLightEnabled: '已开启浅色テーマ',
      notificationLikesDesc: '有人点赞你的壁纸时',
      notificationCommentsDesc: '有人评论你的壁纸时',
      notificationRepliesDesc: '有人回复你的评论时',
  ...
  'en': {
    ...
    profile: {
      ...
      deleteWallpaperConfirm: 'Are you sure you want to delete this wallpaper? This action cannot be undone.',
      ...
      followFailed: 'Operation failed, please try again',
    ...
    settings: {
      ...
      notificationRepliesDesc: 'When someone replies to your comment',
  ...
  'ja': {
    ...
    profile: {
      ...
      goToLogin: 'ログインする',
      confirmDelete: '削除の確認',
      deleteWallpaperConfirm: 'この壁紙を削除してもよろしいですか？この操作は元に戻せません。',
      confirmDeleteText: '削除を確認',
      cancelText: 'キャンセル',
      deleteSuccess: '削除成功',
      deleteFailed: '削除に失敗しました。もう一度お試しください',
      followSuccess: 'フォローしました',
      unfollowSuccess: 'フォローを解除しました',
      followFailed: '操作に失敗しました。もう一度お試しください',
    ...
    settings: {
      ...
      notificationRepliesDesc: 'あなたのコメントに返信がついたとき',
  ...
  'ko': {
    ...
    profile: {
      ...
      goToLogin: '로그인하기',
      confirmDelete: '삭제 확인',
      deleteWallpaperConfirm: '이 배경화면을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
      ...
      followFailed: '작업 실패, 다시 시도하세요',
      loadFailedRetry: '로딩 실패, 다시 시도하세요',
      loadMoreText: '더 보기',
    },
    ...
    settings: {
      ...
      notificationRepliesDesc: '당신의 댓글에 답글이 달릴 때',
  ...
  'es': {
    ...
    profile: {
      ...
      startFollowing: 'Comienza a seguir a usuarios que te interesen',
      followBack: 'Seguir de vuelta',
      mutualFollow: 'Seguir mutuamente',
      unfollow: 'Dejar de seguir',
      follow: 'Seguir',
      pleaseLogin: 'Por favor inicia sesión primero',
      goToLogin: 'Ir a iniciar sesión',
      confirmDelete: 'Confirmar eliminación',
      deleteWallpaperConfirm: '¿Estás seguro de que deseas eliminar este fondo? Esta acción no se puede deshacer.',
      confirmDeleteText: 'Confirmar eliminación',
      cancelText: 'Cancelar',
      deleteSuccess: 'Eliminado exitosamente',
      deleteFailed: 'Error al eliminar, intenta de nuevo',
      followSuccess: 'Seguido',
      unfollowSuccess: 'Dejado de seguir',
      followFailed: 'Operación fallida, intenta de nuevo',
      loadFailedRetry: 'Error al cargar, intenta de nuevo',
    ...
    settings: {
      ...
      notificationRepliesDesc: 'Cuando alguien responde a tu comentario',
  ...
  'fr': {
    ...
    searchPage: {
      ...
      searchPlaceholder: 'Rechercher des fonds d\'écran, des tags...',
      filters: 'Filtres',
    ...
    profile: {
      ...
      uploadFirstWallpaper: 'Téléversez votre premier fond d\'écran pour commencer',
      startFavoriting: 'Commencez à enregistrer les fonds d\'écran que vous aimez',
      settings: 'Paramètres',
      following: 'Abonnements',
      followers: 'Abonnés',
      noFollowingYet: 'Vous ne suivez personne pour le moment',
      noFollowersYet: 'Vous n\'avez pas d\'abonnés pour le moment',
      startFollowing: 'Commencez à suivre les utilisateurs qui vous intéressent',
      ...
      deleteWallpaperConfirm: 'Êtes-vous sûr de vouloir supprimer ce fond d\'écran ? Cette action ne peut être annulée.',
      confirmDeleteText: 'Confirmer la suppression',
      cancelText: 'Annuler',
      ...
      followFailed: 'Échec de l\'opération, veuillez réessayer',
    ...
    upload: {
      ...
      pleaseWait: 'Veuillez patienter pendant que nous traitons votre fond d\'écran',
    ...
    settings: {
      ...
      profileSettingsDesc: 'Mettre à jour vos informations de profil',
      ...
      aboutApp: 'À propos de MarkWallpapers',
      aboutAppDesc: 'En savoir plus sur notre plateforme',
      dangerZone: 'Zone dangereuse',
      privacyPolicy: 'Politique de confidentialité',
      logOut: 'Déconnexion',
      copyright: '© 2026 MarkWallpapers. Tous droits réservés.',
      appVersion: 'MarkWallpapers v1.0.0',
      themeDarkEnabled: 'Thème sombre activé',
      themeLightEnabled: 'Thème clair activé',
      notificationLikesDesc: 'Quand quelqu\'un aime votre fond d\'écran',
      notificationCommentsDesc: 'Quand quelqu\'un commente votre fond d\'écran',
      notificationRepliesDesc: 'Quand quelqu\'un répond à votre commentaire',
